					...
					<div class="newProduct">
						...
						<div class="row">
							<div class="contentItem">
								<!-- Submit -->
								<div class="col s12">
									<button class="waves-effect waves-indigo btn indigo addProductButton disabled">Add Product</button> 
								</div>

								<div class="col s12">
									<p id="newProductFieldWarning" class="fieldResult leftAlign fieldWarning"></p>
								</div>
							</div>
						</div>
					</div>
